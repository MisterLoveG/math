...
external interface JQueryStatic {
    ...
    fun type(obj: Any): dynamic /* String /* "array" */ | String /* "boolean" */ | String /* "date" */ | String /* "error" */ | String /* "function" */ | String /* "null" */ | String /* "number" */ | String /* "object" */ | String /* "regexp" */ | String /* "string" */ | String /* "symbol" */ | String /* "undefined" */ */
